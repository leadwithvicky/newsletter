...
export default function CreateNewsletterPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      editor.on('component:click', (mdl: any, view: any, ev: any) => {
        try {
          const href = mdl?.getAttributes?.().href;
          if (href && (ev?.ctrlKey || ev?.metaKey)) window.open(href, '_blank');
        } catch {}
      });
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white text-black">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {uploading ? <p>Uploading...</p> : form.imageUrl && <img src={form.imageUrl} alt="preview" className="max-h-40 rounded" />}
        </div>
